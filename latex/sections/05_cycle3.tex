...
\section{Brief Outline}
    ...
    % tree:cycle3-hierarchy
    % Cycle 3 Hierarchy diagram
    \begin{figure}[!ht]
        \centering
        \begin{forest}
            for tree={
    ...
    % Will have to address the circuit simulation aspect
...
\section{Design}
    ...
    \subsection{Algorithms}
        ...
        % A graph \(G \) forms a cycle graph if and only if it consists of a single cycle, a cycle being a path that start and ends at the same vertex 
