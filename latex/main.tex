    ...
    \section{Cycle 2: Project Management}
        ...
        \subsection{Design}
            ...
            \subsubsection{Data Structures}
                ...
                % I need a way to store configuration settings for an individual project
                % I need a way to store recently stored projects (globally)
                % I need a way to run projects through command prompt for the main .exe
                % I need to design a file structure for an individual project
