...
\begin{document}
        ...
        \subsection{Implementation}
            ...
            \subsubsection{Installer}
                ...
                \begin{figure}[!ht]
                   ...
                   \label{fig:install_gui_class_diagram}
                \end{figure}
                ...
                In \autoref{sc:install_gui_init_sc_c1}, the position, size, and text of the individual UI elements have been initialised as well as some of the attributes of the main window.
    ...
    def btn_install_command(self) -> None:
        ...
        self.btn_install["state"] = "active"
                ...
                In \autoref{sc:cancel_and_browse_btns_sc_c1}, the browse button will open a dialogue allowing the user to select a folder into which they would like to install the software which will also disable all the buttons while the software is installing. I considered some kind of progress indicator but found it too difficult.
...
class InstallGUI:
    def __init__(self, root):
        ...
        self.filepath = None
                ...
                I decided that the entry box in the installer was redundant thanks to the browse button I introduced which already managed the validation aspect for me, as you can only select an existing directory on your computer. Because of this, I decided to just make it an uneditable label object that will display the directory chosen. This also led me to abandon the idea of introducing a default install directory, as that was initially introduced due to how awkward it would've been to input a directory.


                % installgui_ent_to_lbl_c1
                % Entry to label sc snippet pf
                \begin{figure}[!ht]
                   \begin{minted}[linenos]{python}
        ...
        self.lbl_dir.place(x=20,y=60,width=183,height=30)
                   \end{minted}
                   \caption{Entry that was changed to a label}
                   \label{sc:installgui_ent_to_lbl_c1}
                \end{figure}
...
def install_requirements(url: str) -> None:
    ...
    # pass
                ...
                \begin{figure}[!ht]
                   \begin{center}
                       \includegraphics[width=\textwidth]{figures/installer_req_fail1.png}
                   \end{center}
