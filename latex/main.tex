                    ...
                    \begin{minted}[linenos]{json}
{
    ...
    "lastOpened": "UNIX timestamp"
                ...
                This structure will be implemented with the use of a text file that will store the three most recent projects in order as well as using object-oriented programming.
