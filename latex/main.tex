...
\begin{document}
    ...
    def btn_browse_command(self) -> None:
        ...
        self.btn_install["state"] = "active"
                ...
                In \autoref{sc:cancel_and_browse_btns_sc_c1}, the browse button will open a dialogue allowing the user to select a folder into which they would like to install the software.
...
class InstallGUI:
    def __init__(self, root):
        ...
        self.filepath = None
                ...
                I decided that the entry box in the installer was redundant thanks to the browse button I introduced which already managed the validation aspect for me, as you can only select an existing directory on your computer. Because of this, I decided to just make it an uneditable label object that will display the directory chosen. 
        ...
        self.lbl_dir.place(x=20,y=60,width=183,height=30)
                ...
                In the function tied to the "Install" button, see \autoref{sc:install_btn_sc_c1}, there are two functions called, \verb|install_requirements| and \verb|download_from_github|. The former of these 
