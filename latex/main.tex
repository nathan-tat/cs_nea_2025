        ...
        \subsection{Design}
            ...
            \subsubsection{Algorithms}
                ...
                \begin{tikzpicture}[node distance=2cm]
                    ...
                    \node (in1) [io, below of=start] {Get destination\\directory};
                    \node (dec1) [decision, below of=in1] {User has\\permissions?};
                    \node (exc1) [startstop, left of=dec1] {Raise exception};
                    \node (pro1) [process, below of=dec1] {Move zip archive to destination};
