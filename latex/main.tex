    ...
    \section{Cycle 1: Project and File Management}
        ...
        \subsection{Design}
            ...
            \subsubsection{User Interface}
                ...
                \begin{figure}[!ht]
                    \begin{center}
                        \includegraphics[width=.25\textwidth]{figures/c1/install_gui_class_diagram.png}
                    \end{center}
                ...
                \begin{figure}[!ht]
                   \begin{center}
                       \includegraphics[width=.5\textwidth]{figures/c1/installer_ui_design_mock.png}
                   \end{center}
                   \caption{UI Design}
            ...
            \subsubsection{Algorithms}
                ...
                \begin{figure}[!ht]
                    \begin{center}
                        \includegraphics[width=.2\textwidth]{figures/c1/exporting_fc.png}
                    \end{center}
...
class InstallGUI:
    def __init__(self, root):
        ...
        self.filepath = None
                ...
                \begin{figure}[!ht]
                    \begin{center}
                        \includegraphics[width=.5\textwidth]{figures/c1/installer_gui_pf1.png}
                    \end{center}
...
def install_requirements(url: str) -> None:
    ...
    # pass
                ...
                \begin{figure}[!ht]
                   \begin{center}
                       \includegraphics[width=\textwidth]{figures/c1/installer_req_fail1.png}
                   \end{center}
