...
\begin{document}
    ...
    \section{Analysis}
        ...
        \subsection{Success Criteria of the Proposed System}
            ...
            % Add success criteria relating to the installer into the table above
            % Also learn to format tables in LaTeX.
    ...
    \section{Cycle 1: Installation}
        ...
        \subsection{Design}
            ...
            \subsubsection{Data Structures}
                ...
                %     project_name & String (variable) & Name of the project, will be used in displays and for organisational purposes.\\
                %     \bottomrule
                %     \end{tabularx}
                %     \caption{Caption}
                % \end{table}
    ...
    procedure install_software(target)
        ...
        \subsection{Testing}
            ...
            \begin{table}[!ht]
                \centering
                \begin{tabular}[t]{@{}lm{.18\textwidth}m{.18\textwidth}m{.18\textwidth}m{.18\textwidth}}
...
def install_requirements(url: str) -> None:
    ...
    # pass
        ...
        \subsection{Evaluation}
            % Do the testing as well as the evaluation
    ...
    \section{Cycle 2: Project Management}
        ...
        \subsection{Design}
            ...
            \subsubsection{Data Structures}
                ...
                \begin{itemize}
                    \item I need a way to store configureation settings for an individual project
                    \item I need a way to store recently stored projects globally
                    \item I need a way to run projects through the command prompt for the main executable
                    \item I need to design a file structure for an individual project
                \end{itemize}
