    ...
    \section{Analysis}
        ...
        \subsection{Success Criteria of the Proposed System}
            ...
            \begin{table}[!ht]
                \begin{center}
                \footnotesize
                \begin{tabular}{|m{12pt}|m{189pt}|m{189pt}|m{12pt}|}
                \hline
            ...
            \begin{table}[!ht]
                \begin{center}
                \footnotesize
                \begin{tabular}{|m{12pt}|m{200pt}|m{200pt}|}
                \hline
        ...
        \subsection{Brief Outline}
            ...
            \subsubsection{Success Criteria}
                ...
                \begin{table}[!ht]
                    ...
                    \hline
                    ID & Feature \\ \hline
                    B4 & Being able to export and import circuit arrangements. \\ \hline
                    X1 & Only open directories that include all relevant files, raising an exception when this isn't met. \\ \hline
                    X2 & Copy relevant files from the source directory in order to initialise a project. \\ \hline
                    X3 & Allow user to specify directory for exporting. \\ \hline
                    X4 & Compress exported files intuitively. \\ \hline
                    \end{tabular}
                \end{center}
